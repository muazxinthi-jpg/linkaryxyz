...
VALUES
  ...
  (
    ...
    'Summarize what happened in the selected range, what appears to be working, what needs attention, evidence quality, next actions, and data gaps using only this authoritative Growth Intelligence payload: {{input}}',
