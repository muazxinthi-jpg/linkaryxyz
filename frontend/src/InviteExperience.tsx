    ...
    <div className="ops-stack invite-workspace private-network-workspace">
      ...
      {privateView === 'invites' && (
        <>
          ...
          <div className="ops-message">Earn 2 invite credits when a direct referral publishes a public creator profile. Earn 1 additional credit when a Gen 2–7 referral qualifies.</div>
