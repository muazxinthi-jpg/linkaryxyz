      ...
      <section className="onboarding-card">
        ...
        <form onSubmit={submit}>
          ...
          <div className="field-grid">
            <label>Linkary username<div className="username-field"><span>linkary.xyz/</span><input value={username} readOnly={accountType === 'project'} onChange={(event) => setUsername(event.target.value.toLowerCase().replace(/[^a-z0-9_]/g, ''))} placeholder="username" minLength={3} maxLength={30} required /></div><small>{accountType === 'project' ? 'Locked to the verified Project X handle.' : status.xIdentity?.current_handle ? 'Prefilled from your connected X identity. You can choose your Linkary public username.' : 'Choose your Linkary public username. This does not connect or verify an X identity.'}</small></label>
