...
import PromotionAuctionPaymentPanel from './PromotionAuctionPaymentPanel';
...
export default function PromotionAuctionExperience({ me, status }: { me: ProductMe; status: ProductStatus }) {
  ...
  const payerProfileId = status.profiles[0]?.id || '';
  ...
  return (
    <main className="promotion-auction-page">
      <a className="promotion-back" href="/bids">← Back to bids</a>
