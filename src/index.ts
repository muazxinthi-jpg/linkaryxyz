...
const STATIC_OR_SYSTEM = new Set(['', 'index.html', 'styles.css', 'script.js', 'uilib.md', 'favicon.ico', 'assets', 'api', 'onboarding', 'admin', 'app', 'login', 'robots.txt', 'sitemap.xml', 'pricing', 'about', 'blog', 'privacy', 'terms', 'support', 'help', 'status', 'security']);
...
async function handleApi(request: Request, env: Env): Promise<Response> {
  ...
  // Temporary migration fallback. New UI must use CDP.
