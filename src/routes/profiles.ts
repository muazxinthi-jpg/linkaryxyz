...
export async function renderPublicProfile(request: Request, env: Env, username: string): Promise<Response> {
  ...
  css += `@media(min-width:820px){.page{min-height:unset;margin:38px auto;border:1px solid #ff704855;border-radius:30px;overflow:hidden;background:linear-gradient(180deg,#2a130fe6 0%,#100d0be8 32%,#100d0bf0 100%);box-shadow:0 24px 90px #000b}}@media(max-width:819px){.page{background:#160d0be8;border-color:#ff704855}}.matrix{z-index:10!important;opacity:.78!important;mix-blend-mode:screen}.matrix-fallback{position:fixed!important;inset:0!important;overflow:hidden!important;pointer-events:none!important}.matrix-fallback span{display:block!important;z-index:1!important;top:-20vh!important;color:#ff7048!important;opacity:.82!important;text-shadow:0 0 14px #ff4b1f!important}.matrix-fallback:before,.matrix-fallback:after{content:'L\\A I\\A N\\A K\\A A\\A R\\A Y';white-space:pre;position:fixed;top:-20vh;color:#ff7048;font:700 12px/1.3 ui-monospace,monospace;opacity:.8;text-shadow:0 0 14px #ff4b1f;animation:rain 10s linear infinite}.matrix-fallback:before{left:12%}.matrix-fallback:after{left:86%;animation-delay:-4s}`;
