...
async function renderPublicProfileV2(request: Request, env: Env, username: string): Promise<Response> {
  ...
  const rainWords = [profile.username.toUpperCase(), 'LINKARY', profile.profile_type === 'project' ? 'PROJECT' : 'CREATOR', 'PROOF', 'GROWTH', 'ATTRIBUTION', 'IDENTITY', 'NETWORK'];
