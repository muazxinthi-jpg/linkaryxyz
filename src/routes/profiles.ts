...
export async function renderPublicProfileCard(request: Request, env: Env, username: string): Promise<Response> {
  ...
  const card = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630" role="img" aria-labelledby="title desc"><title id="title">${svgText(copy.title)}</title><desc id="desc">${svgText(copy.description)}</desc><defs><linearGradient id="bg" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#fffaf4"/><stop offset="1" stop-color="#f5ece3"/></linearGradient><pattern id="dots" width="42" height="42" patternUnits="userSpaceOnUse"><circle cx="3" cy="3" r="2" fill="#ff5a36" opacity=".18"/><circle cx="24" cy="24" r="1.5" fill="#17110e" opacity=".12"/></pattern></defs><rect width="1200" height="630" rx="28" fill="url(#bg)"/><rect x="38" y="38" width="1124" height="554" rx="22" fill="url(#dots)"/><rect x="38" y="38" width="1124" height="554" rx="22" fill="none" stroke="#ff5a36" stroke-opacity=".28" stroke-width="3"/><rect x="78" y="78" width="13" height="94" rx="6" fill="#ff5a36"/><rect x="100" y="78" width="13" height="62" rx="6" fill="#17110e"/><rect x="122" y="78" width="13" height="38" rx="6" fill="#ff5a36"/><text x="164" y="111" fill="#17110e" font-family="Arial,Helvetica,sans-serif" font-size="32" font-weight="800">Linkary</text><text x="164" y="145" fill="#b94b31" font-family="Arial,Helvetica,sans-serif" font-size="17" font-weight="700">${svgText(copy.typeLabel.toUpperCase())} PROFILE</text><circle cx="982" cy="150" r="80" fill="#17110e"/><text x="982" y="174" text-anchor="middle" fill="#fffaf4" font-family="Arial,Helvetica,sans-serif" font-size="58" font-weight="800">${svgText(initials, 2)}</text><text x="82" y="294" fill="#17110e" font-family="Arial,Helvetica,sans-serif" font-size="64" font-weight="800">${svgText(profile.display_name, 28)}</text><text x="86" y="338" fill="#765f54" font-family="Arial,Helvetica,sans-serif" font-size="25">@${svgText(profile.username, 36)}</text><text x="86" y="414" fill="#2d2420" font-family="Arial,Helvetica,sans-serif" font-size="28" font-weight="600">${svgText(copy.detail, 68)}</text><text x="86" y="454" fill="#2d2420" font-family="Arial,Helvetica,sans-serif" font-size="28" font-weight="600">${svgText(copy.detail.slice(68), 68)}</text><text x="86" y="532" fill="#ff5a36" font-family="Arial,Helvetica,sans-serif" font-size="21" font-weight="700">linkary.xyz/${svgText(profile.username, 36)}</text></svg>`;
