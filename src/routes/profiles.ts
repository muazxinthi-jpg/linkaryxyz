...
export async function renderPublicProfile(request: Request, env: Env, username: string): Promise<Response> {
  ...
  css += `@media(min-width:820px){.page{min-height:unset;margin:38px auto;border:1px solid #ff704855;border-radius:30px;overflow:hidden;background:linear-gradient(180deg,#2a130fe6 0%,#100d0be8 32%,#100d0bf0 100%);box-shadow:0 24px 90px #000b}}@media(max-width:819px){.page{background:#160d0be8;border-color:#ff704855}}.matrix{display:block!important;z-index:10!important;opacity:.78!important;mix-blend-mode:screen}.matrix-fallback{position:fixed!important;inset:0!important;overflow:hidden!important;pointer-events:none!important}.matrix-fallback span{display:block!important;z-index:1!important;top:-20vh!important;color:#ff7048!important;opacity:.82!important;text-shadow:0 0 14px #ff4b1f!important}body:before,body:after{content:'L\\A I\\A N\\A K\\A A\\A R\\A Y\\A 0\\A 1\\A 7\\A 9\\A A\\A T\\A T\\A R';white-space:pre;position:fixed;top:-20vh;color:#ff7048;font:700 12px/1.3 ui-monospace,monospace;opacity:.8;text-shadow:0 0 14px #ff4b1f;animation:rain 10s linear infinite;z-index:11;pointer-events:none}body:before{left:4%;box-shadow:180px 0 #ff7048,360px 0 #ff7048,540px 0 #ff7048,720px 0 #ff7048,900px 0 #ff7048,1080px 0 #ff7048,1260px 0 #ff7048,1440px 0 #ff7048}body:after{left:9%;animation-delay:-4s;box-shadow:180px 0 #ff7048,360px 0 #ff7048,540px 0 #ff7048,720px 0 #ff7048,900px 0 #ff7048,1080px 0 #ff7048,1260px 0 #ff7048}`;
