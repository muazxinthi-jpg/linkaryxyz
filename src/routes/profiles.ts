...
async function renderPublicProfileV2(request: Request, env: Env, username: string): Promise<Response> {
  ...
  css += `.signals{display:flex;flex-wrap:wrap;justify-content:center;gap:7px;margin:18px auto 0;max-width:570px}.signals span{border:1px solid #ff704855;border-radius:999px;background:#ff4b1f16;padding:6px 9px;color:#ffcfbf;font:700 9px/1 ui-monospace,monospace;letter-spacing:.07em}`;
