...
.linkary-sponsored-banner{display:block;width:100%;height:clamp(330px,34vw,420px);border-radius:28px;overflow:hidden;background:#f2f2f2;border:1px solid rgba(255,85,0,.18);box-shadow:0 18px 44px rgba(38,24,17,.14);clip-path:ellipse(100% 100% at 50% 0)}
...
@media(max-width:640px){.linkary-sponsored-header{--linkary-avatar-overlap:72px;--linkary-cta-avatar-gap:20px;width:calc(100vw - 24px);margin-top:14px;border-radius:20px}.linkary-sponsored-banner{height:280px;border-radius:20px}.linkary-sponsored-cta{height:40px;min-width:112px;padding:0 18px}.linkary-featured-project{max-width:62%;font-size:10px}.linkary-promotion-hero .avatar{width:clamp(132px,40vw,168px)!important;height:clamp(132px,40vw,168px)!important;border-width:4px!important}.linkary-sponsored-header + script + .linkary-promotion-hero,.linkary-sponsored-header + .linkary-promotion-hero{margin-top:-72px!important}}
</style>`;
