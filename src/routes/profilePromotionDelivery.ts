...
.linkary-promotion-top{position:absolute!important;top:clamp(16px,1.7vw,24px)!important;left:50%!important;transform:translateX(-50%)!important;width:min(1120px,calc(100vw - 40px))!important;box-sizing:border-box!important;padding:0 clamp(18px,2vw,28px)!important;margin:0!important;z-index:20!important;pointer-events:none!important}
.linkary-promotion-top>*{pointer-events:auto!important}
.linkary-sponsored-header{--linkary-avatar-overlap:clamp(88px,6.8vw,104px);--linkary-cta-avatar-gap:clamp(44px,3.4vw,52px);position:relative;z-index:5;width:min(1120px,calc(100vw - 40px));margin:0 50% 0;transform:translateX(-50%);border-radius:28px;overflow:visible;isolation:isolate}
.linkary-sponsored-banner{display:block;width:100%;height:clamp(310px,26vw,360px);border-radius:28px;overflow:hidden;background:#f2f2f2;border:1px solid rgba(255,85,0,.18);box-shadow:0 18px 44px rgba(38,24,17,.14);clip-path:ellipse(100% 100% at 50% 0)}
...
.linkary-sponsored-label{position:absolute;top:64px;right:20px;z-index:7;padding:6px 10px;border-radius:999px;background:rgba(17,17,17,.72);backdrop-filter:blur(8px);color:#fff;font:700 10px/1 system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;letter-spacing:.05em;text-transform:uppercase}
.linkary-featured-project{position:absolute;left:20px;top:64px;z-index:7;max-width:55%;padding:7px 11px;border-radius:999px;background:rgba(255,255,255,.92);backdrop-filter:blur(8px);color:#111;font:750 11px/1.2 system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;box-shadow:0 6px 18px rgba(17,17,17,.08)}
...
@media(max-width:640px){.linkary-promotion-top{top:12px!important;width:calc(100vw - 20px)!important;padding:0 12px!important}.linkary-sponsored-header{--linkary-avatar-overlap:72px;--linkary-cta-avatar-gap:30px;width:calc(100vw - 20px);border-radius:20px}.linkary-sponsored-banner{height:270px;border-radius:20px}.linkary-sponsored-cta{height:40px;min-width:112px;padding:0 18px}.linkary-sponsored-label{top:58px;right:12px}.linkary-featured-project{top:58px;left:12px;max-width:58%;font-size:10px}.linkary-promotion-hero .avatar{width:clamp(128px,36vw,152px)!important;height:clamp(128px,36vw,152px)!important;border-width:4px!important;border-radius:20px!important}.linkary-sponsored-header + script + .linkary-promotion-hero,.linkary-sponsored-header + .linkary-promotion-hero{margin-top:-72px!important}}
</style>`;
