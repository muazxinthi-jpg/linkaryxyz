...
.linkary-promotion-top{position:absolute!important;top:clamp(18px,2vw,30px)!important;left:50%!important;transform:translateX(-50%)!important;width:min(1500px,calc(100vw - 48px))!important;box-sizing:border-box!important;padding:0 clamp(18px,2.2vw,34px)!important;margin:0!important;z-index:20!important;pointer-events:none!important}
.linkary-promotion-top>*{pointer-events:auto!important}
.linkary-sponsored-header{--linkary-avatar-overlap:clamp(92px,7.6vw,116px);--linkary-cta-avatar-gap:clamp(24px,2.2vw,32px);position:relative;z-index:5;width:min(1500px,calc(100vw - 48px));margin:0 50% 0;transform:translateX(-50%);border-radius:30px;overflow:visible;isolation:isolate}
.linkary-sponsored-banner{display:block;width:100%;height:clamp(350px,32vw,430px);border-radius:30px;overflow:hidden;background:#f2f2f2;border:1px solid rgba(255,85,0,.18);box-shadow:0 18px 44px rgba(38,24,17,.14);clip-path:ellipse(100% 100% at 50% 0)}
...
.linkary-sponsored-label{position:absolute;top:72px;right:22px;z-index:7;padding:6px 10px;border-radius:999px;background:rgba(17,17,17,.72);backdrop-filter:blur(8px);color:#fff;font:700 10px/1 system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;letter-spacing:.05em;text-transform:uppercase}
.linkary-featured-project{position:absolute;left:22px;top:72px;z-index:7;max-width:55%;padding:7px 11px;border-radius:999px;background:rgba(255,255,255,.92);backdrop-filter:blur(8px);color:#111;font:750 11px/1.2 system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;box-shadow:0 6px 18px rgba(17,17,17,.08)}
...
.linkary-promotion-hero .avatar{width:clamp(184px,15vw,224px)!important;height:clamp(184px,15vw,224px)!important;position:relative!important;z-index:10!important;border:5px solid #fff!important;border-radius:30px!important;box-shadow:0 14px 38px rgba(42,28,20,.16)!important;overflow:hidden!important}
@media(max-width:640px){.linkary-promotion-top{top:14px!important;width:calc(100vw - 24px)!important;padding:0 14px!important}.linkary-sponsored-header{--linkary-avatar-overlap:70px;--linkary-cta-avatar-gap:20px;width:calc(100vw - 24px);border-radius:20px}.linkary-sponsored-banner{height:290px;border-radius:20px}.linkary-sponsored-cta{height:40px;min-width:112px;padding:0 18px}.linkary-sponsored-label{top:62px;right:12px}.linkary-featured-project{top:62px;left:12px;max-width:58%;font-size:10px}.linkary-promotion-hero .avatar{width:clamp(132px,38vw,160px)!important;height:clamp(132px,38vw,160px)!important;border-width:4px!important;border-radius:22px!important}.linkary-sponsored-header + script + .linkary-promotion-hero,.linkary-sponsored-header + .linkary-promotion-hero{margin-top:-70px!important}}
</style>`;
