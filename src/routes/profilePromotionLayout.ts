const PROMOTION_LAYOUT_REFINEMENT = `<style id="linkary-promotion-layout-refinement-v3">
/* Geometry-only refinement. This intentionally does not alter promotion data, links or tracking. */
@media(min-width:1025px){
  .page.linkary-promotion-page .linkary-promotion-top{top:-30px!important;width:min(900px,calc(100vw - 96px))!important;padding-inline:18px!important}
  .page.linkary-promotion-page .linkary-sponsored-header{--linkary-cta-avatar-gap:clamp(68px,4.8vw,78px);width:min(900px,calc(100vw - 96px))!important;margin-top:-44px!important}
...
@media(min-width:641px) and (max-width:1024px){
  .page.linkary-promotion-page .linkary-promotion-top{top:-18px!important;width:min(860px,calc(100vw - 48px))!important;padding-inline:16px!important}
  .page.linkary-promotion-page .linkary-sponsored-header{--linkary-cta-avatar-gap:clamp(56px,5vw,66px);width:min(860px,calc(100vw - 48px))!important;margin-top:-30px!important}
...
@media(max-width:640px){
  .page.linkary-promotion-page .linkary-promotion-top{top:-2px!important;width:calc(100vw - 24px)!important;padding-inline:10px!important}
  .page.linkary-promotion-page .linkary-sponsored-header{--linkary-cta-avatar-gap:40px;width:calc(100vw - 24px)!important;margin-top:-16px!important}
