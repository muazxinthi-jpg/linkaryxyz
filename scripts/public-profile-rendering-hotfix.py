...
Path('tests/public-profile-rendering-hotfix.test.ts').write_text(r'''import test from 'node:test';
...
Path('tests/public-profile-analytics-layout-regression.test.ts').write_text(r'''import test from 'node:test';
import assert from 'node:assert/strict';
import { readFileSync } from 'node:fs';
